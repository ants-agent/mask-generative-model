...
def calculate_fvd(videos1, videos2, device, method="styleganv"):
    ...
    if method == "styleganv":
        from common_metrics_on_video_quality.fvd.styleganv.fvd import (
            get_fvd_feats,
            frechet_distance,
            load_i3d_pretrained,
        )
