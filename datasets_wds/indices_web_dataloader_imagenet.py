...
# include the logic of loading imagenet raw data, you can resize it to 256 or 512 on the fly in the webdataset.
    ...
    def __init__(
        ...
        **kwargs,  #
        ...
        train_processing_pipeline = [
            ...
            wds.rename(
                indices="indices.npy",
                cls_id="cls;cls_id.cls",
                handler=wds.warn_and_continue,
            ),
            wds.map(filter_keys(set(["indices", "cls_id", "filename"]))),
            wds.map_dict(
                cls_id=lambda x: int(x),
                handler=wds.warn_and_continue,
            ),
        ]
...
if __name__ == "__main__":
    dataloader = SimpleImageDataset(
        train_shards_path="./data/imagenet256_shuffled_raw_wds_train_realflip1_indices_v4/train-{000000..000707}.tar",
        eval_shards_path="./data/imagenet256_shuffled_raw_wds_train_realflip1_indices_v4/train-{000000..000707}.tar",
