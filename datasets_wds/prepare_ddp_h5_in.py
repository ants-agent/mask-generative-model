...
accelerator = Accelerator(fsdp_plugin=None, deepspeed_plugin=None)
...
if __name__ == "__main__":
    ...
    # CUDA_LAUNCH_BLOCKING=1 CUDA_VISIBLE_DEVICES=4,5,6,7 accelerate launch  --mixed_precision no  --num_processes 4 --num_machines 1 --multi_gpu --main_process_ip 127.0.0.1 --main_process_port 8878  datasets_wds/wds_prepare_in_h5.py

# CUDA_VISIBLE_DEVICES=0,1,2,3 python -m torch.distributed.launch --nproc_per_node=4  --master_port=8879  datasets_wds/prepare_ddp_h5_in.py
